...
export const cssCategoriesConfig = Object.keys(cssConfig.properties);
export const boxModelProperties = Object.keys(cssConfig.properties.boxModel.properties);
export const positioningProperties = Object.keys(cssConfig.properties.positioning.properties);
export const typographyProperties = Object.keys(cssConfig.properties.typography.properties);
export const backgroundProperties = Object.keys(cssConfig.properties.background.properties);
export const flexboxProperties = Object.keys(cssConfig.properties.flexbox.properties);
export const gridProperties = Object.keys(cssConfig.properties.grid.properties);
export const animationsProperties = Object.keys(cssConfig.properties.animations.properties);
export const transitionsProperties = Object.keys(cssConfig.properties.transitions.properties);
export const filtersProperties = Object.keys(cssConfig.properties.filters.properties);
export const bordersProperties = Object.keys(cssConfig.properties.borders.properties);
export const listsProperties = Object.keys(cssConfig.properties.lists.properties);
export const tablesProperties = Object.keys(cssConfig.properties.tables.properties);
export const transformsProperties = Object.keys(cssConfig.properties.transforms.properties);
export const miscellaneousProperties = Object.keys(cssConfig.properties.miscellaneous.properties);
